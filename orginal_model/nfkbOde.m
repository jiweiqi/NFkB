function delta = nfkbOde(t,x,v)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ODE file for the whole model.  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
flux_rsr_fn        = v.TP(2)  * (NFkBn ^ v.TP(3))/ ...
    (NFkBn ^ v.TP(3) + v.TP(4)^v.TP(3)); %tnf transcription 
...
% TNF component 
delta(36,1)     = delta_TNFnas  ;
delta(37,1)     = delta_TNFmRNA ;
delta(38,1)     = delta_TNFpro  ;
delta(39,1)     = delta_TNF  ;

% TNFR part
delta(40,1)     = delta_tnfrm;
delta(41,1)     = delta_TNFR;
delta(42,1)     = delta_TNFRtnf;
delta(43,1)     = delta_C1;
delta(44,1)     = delta_C1_off  ;
delta(45,1)     = delta_C1tnf  ;
delta(46,1)     = delta_C1tnf_off   ;
delta(47,1)     = delta_TTR ;

% A20
delta(48,1)     = delta_a20 ;
delta(49,1)     = delta_a20t ;
